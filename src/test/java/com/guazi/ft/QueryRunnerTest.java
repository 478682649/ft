...
import com.guazi.ft.db.dbutil.TxQueryRunner;
...
public class QueryRunnerTest {
	...
	public void txQueryByIdToMap() throws Exception {
		...
		UserDO user = CommonUtil.map2Bean(map, UserDO.class, null);
		System.out.println(JsonUtil.object2Json(user));
		...
		user = CommonUtil.map2Bean(userMap, UserDO.class, "yyyy-MM-dd HH:mm:ss");
